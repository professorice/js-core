...
## [3.0.0](https://github.com/professorice/js-core/compare/js-server-sdk-common-edge-v2.3.9...js-server-sdk-common-edge-v3.0.0) (2024-09-06)
...
* The following workspace dependencies were updated
  * dependencies
    * @launchdarkly/js-server-sdk-common bumped from 2.6.1 to 3.0.0
