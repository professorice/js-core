...
## [5.0.0](https://github.com/professorice/js-core/compare/node-server-sdk-redis-v4.1.21...node-server-sdk-redis-v5.0.0) (2024-09-06)
...
* The following workspace dependencies were updated
  * devDependencies
    * @launchdarkly/node-server-sdk bumped from 9.5.4 to 10.0.0
  * peerDependencies
